...
namespace SchoolManagmentApp.MVC.Controllers
{
    ...
    public class EnrollmentsController : Controller
    {
        ...
        public EnrollmentsController(SchoolManagmentDbContext context)
        {
            _context = context;
        }
        ...
        {
            var schoolManagmentDbContext = _context.Enrollments.Include(e => e.Class).Include(e => e.Student);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SchoolManagmentDbContext.Enrollments'  is null.");
            }
            var enrollment = await _context.Enrollments.FindAsync(id);
            if (enrollment != null)
            {
