...
public partial class SchoolManagmentDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Classes__3214EC076A7ED06C");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Courses__3214EC0754E8BD32");

            entity.HasIndex(e => e.Code, "UQ__Courses__A25C5AA7ADEEB58F").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Enrollme__3214EC07B2CDEEAD");
